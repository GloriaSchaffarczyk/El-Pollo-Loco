class Character extends MovableObject {
    ...
    IMAGES_IDLE = [
        'img/2_character/1_idle/idle/biker_idle_01.png',
        'img/2_character/1_idle/idle/biker_idle_02.png',
        'img/2_character/1_idle/idle/biker_idle_03.png',
        'img/2_character/1_idle/idle/biker_idle_04.png',
    ];
    IMAGES_LONG_IDLE = [
        'img/2_character/1_idle/long_idle/biker_long_idle_01.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_02.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_03.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_04.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_05.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_06.png',
        'img/2_character/1_idle/idle/biker_idle_01.png',
        'img/2_character/1_idle/idle/biker_idle_02.png',
        'img/2_character/1_idle/idle/biker_idle_03.png',
        'img/2_character/1_idle/idle/biker_idle_04.png',
        ...
        'img/2_character/1_idle/idle/biker_idle_03.png',
        'img/2_character/1_idle/idle/biker_idle_04.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_angry_01.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_angry_02.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_angry_03.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_angry_04.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_angry_05.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_angry_06.png',
        'img/2_character/1_idle/idle/biker_idle_01.png',
        'img/2_character/1_idle/idle/biker_idle_02.png',
        'img/2_character/1_idle/idle/biker_idle_03.png',
        'img/2_character/1_idle/idle/biker_idle_04.png',
        ...
        'img/2_character/1_idle/idle/biker_idle_03.png',
        'img/2_character/1_idle/idle/biker_idle_04.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_sit_01.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_sit_02.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_sit_03.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_sit_03.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_sit_03.png',
        'img/2_character/1_idle/long_idle/biker_long_idle_sit_04.png',
        'img/2_character/1_idle/idle/biker_idle_01.png',
        'img/2_character/1_idle/idle/biker_idle_02.png',
        'img/2_character/1_idle/idle/biker_idle_03.png',
        'img/2_character/1_idle/idle/biker_idle_04.png',
    ...
    IMAGES_WALK = [
        'img/2_character/2_walk/biker_walk_01.png',
        'img/2_character/2_walk/biker_walk_02.png',
        'img/2_character/2_walk/biker_walk_03.png',
        'img/2_character/2_walk/biker_walk_04.png',
        'img/2_character/2_walk/biker_walk_05.png',
        'img/2_character/2_walk/biker_walk_06.png',
    ];
    IMAGES_JUMP = [
        'img/2_character/3_jump/biker_jump_01.png',
        'img/2_character/3_jump/biker_jump_02.png',
        'img/2_character/3_jump/biker_jump_03.png',
        'img/2_character/3_jump/biker_jump_04.png',
    ];
    IMAGES_DOUBLE_JUMP = [
        'img/2_character/3_jump/biker_doublejump_01.png',
        'img/2_character/3_jump/biker_doublejump_02.png',
        'img/2_character/3_jump/biker_doublejump_03.png',
        'img/2_character/3_jump/biker_doublejump_04.png',
        'img/2_character/3_jump/biker_doublejump_05.png',
        'img/2_character/3_jump/biker_doublejump_06.png',
    ];
    IMAGES_HURT = [
        'img/2_character/4_hurt/biker_hurt_01.png',
        'img/2_character/4_hurt/biker_hurt_02.png',
    ];
    IMAGES_DEAD = [
        'img/2_character/5_dead/biker_death_01.png',
        'img/2_character/5_dead/biker_death_02.png',
        'img/2_character/5_dead/biker_death_03.png',
        'img/2_character/5_dead/biker_death_04.png',
        'img/2_character/5_dead/biker_death_05.png',
        'img/2_character/5_dead/biker_death_06.png',
    ];
    IMAGES_THROWINGBOMBS = [
        'img/2_character/6_throw/biker_throw_01.png',
        'img/2_character/6_throw/biker_throw_02.png',
        'img/2_character/6_throw/biker_throw_03.png',
        'img/2_character/6_throw/biker_throw_04.png',
        'img/2_character/6_throw/biker_throw_05.png',
        'img/2_character/6_throw/biker_throw_06.png',
    ];
     ...
     */
    constructor() {
        super().loadImage('img/2_character/2_walk/biker_walk_01.png')
