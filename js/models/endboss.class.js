class Endboss extends MovableObject {
    ...
    constructor() {
        super().loadImage('../img2/4_boss/1_walk/boss_walk_right_01.png');
    ...
    animate() {
        setInterval(() => {
            let i = this.currentImage % this.ENDBOSS_IMAGES_WALKING.length;
            let path = this.ENDBOSS_IMAGES_WALKING[i];
