...
function initLevel() {
    LEVEL1 = new Level(
        ...
        [
            ...
            new BackgroundObject('img2/5_background/layers/3_third_layer/cemetary_thirdlayer_night.png', 1706, 0),
            new BackgroundObject('img2/5_background/layers/2_second_layer/cemetary_secondlayer_night.png', 1706, 0),
            new BackgroundObject('img2/5_background/layers/1_first_layer/cemetary_firstlayer_night.png', 1706, 0),
            new BackgroundObject('img2/5_background/layers/cemetary_background_night_02.png', 2559, 0),
            new BackgroundObject('img2/5_background/layers/3_third_layer/cemetary_thirdlayer_night_02.png', 2559, 0),
            new BackgroundObject('img2/5_background/layers/2_second_layer/cemetary_secondlayer_night_02.png', 2559, 0),
            new BackgroundObject('img2/5_background/layers/1_first_layer/cemetary_firstlayer_night_02.png', 2559, 0),
        ],
    );
}
